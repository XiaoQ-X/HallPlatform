<template>
  <div class="min-h-screen flex">
    <!-- 侧边导航 -->
    <aside :class="['glass sticky top-0 h-screen w-64 flex flex-col p-4 rounded-r-[2rem] z-40 transition-all duration-300', collapsed&&'w-24']">
      ...
      <div class="overflow-y-auto flex-1 mt-3 pr-1 space-y-4">
        <div>
      ...
      <header class="sticky top-0 z-30 px-6 py-3 glass flex items-center gap-4 rounded-b-[1.6rem]">
        ...
        <div class="ml-auto flex items-center gap-3">
          ...
          <div class="relative">
            ...
            <div v-if="showNoti" class="absolute right-0 mt-2 w-80 card p-3 z-50">
...
const collapsed = ref(false), showProfile = ref(false);
...
const title = computed(() => titleMap[route.path] || '霍尔效应平台');
